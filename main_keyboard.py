"""
EmotiArm — KEYBOARD DEMO MODE (for hackathon presentation)
...
print("="*60)
print("EmotiArm KEYBOARD DEMO MODE")
print("="*60)
print("Controls:")
print("  s = SAD        → arm pats + comforts")
print("  d = DISTRACTED → arm slaps + yells focus")
print("  n = NEUTRAL    → arm rests")
print("  q = QUIT")
print("="*60)
move(REST, 0.5)
